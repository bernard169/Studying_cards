...
"}")
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap("images/highlight.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.formatMenuQ.addItem(icon10, "")
        self.formatMenuQ.setItemText(5, "")
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap("images/redSquare.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.formatMenuQ.addItem(icon11, "")
        self.formatMenuQ.setItemText(6, "")
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap("images/greenSquare.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.formatMenuQ.addItem(icon12, "")
        self.formatMenuQ.setItemText(7, "")
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap("images/purpleSquare.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.formatMenuQ.addItem(icon13, "")
        ...
        self.formatMenuA.addItem(icon12, "")
        self.formatMenuA.setItemText(7, "")
        self.formatMenuA.addItem(icon13, "")
